    ...
    let(:param) {
      {
        ...
        importing_items_attributes: [{
          ...
          itemable_attributes: {
            id: "", code: "vdo_001", name: "Video title", url: "http://example.com", author: "ABC"
          }
        }]
      }
    }
      ...
      let(:param2) {
        {
          ...
          importing_items_attributes: [{
            ...
            itemable_attributes: {
              id: batch1.videos.last.id, code: "vdo_001", name: "Video title2", url: "http://example.com", author: "ABC"
            }
          }]
        }
      }
